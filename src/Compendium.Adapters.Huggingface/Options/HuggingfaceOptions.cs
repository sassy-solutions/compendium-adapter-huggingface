...
namespace Compendium.Adapters.Huggingface.Options;

/// <summary>
/// Configuration for <see cref="HuggingfaceAdapter"/>.
/// </summary>
public sealed class HuggingfaceOptions
{
    ...
    /// </summary>
    public const string SectionName = "Compendium:Adapters:Huggingface";
