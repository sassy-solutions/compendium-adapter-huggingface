// -----------------------------------------------------------------------
// <copyright file="HuggingfaceAdapter.cs" company="Sassy Solutions">
...
namespace Compendium.Adapters.Huggingface;

/// <summary>
/// Huggingface adapter — replace with the real vendor implementation.
...
/// </list>
/// </summary>
public sealed class HuggingfaceAdapter
{
    private readonly HuggingfaceOptions _options;
    private readonly ILogger<HuggingfaceAdapter> _logger;

    /// <summary>
    /// Creates a new <see cref="HuggingfaceAdapter"/>.
    /// </summary>
    /// <param name="options">Adapter configuration.</param>
    /// <param name="logger">Diagnostic logger.</param>
    public HuggingfaceAdapter(IOptions<HuggingfaceOptions> options, ILogger<HuggingfaceAdapter> logger)
    {
